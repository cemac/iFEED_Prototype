...
NC_DIR='/nobackup/earsj/out/nc_outs'

# directory job std out / std err:
JOB_OUT='/nobackup/earsj/job_out_consolidate'

# directory for completed job scripts:
JOB_DONE='/nobackup/earsj/consolidate_completed'

# conda install location
CONDA_LOC='/nobackup/earsj/miniconda3'

# python script location
PYLOC='/nobackup/earsj'
...
python3 year_collator.py ${RCP_DATA_DIR} ${NC_DIR} ${N_PROC}
EOF
